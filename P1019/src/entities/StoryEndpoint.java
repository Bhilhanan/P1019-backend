...
@Api(name = "storyendpoint", namespace = @ApiNamespace(ownerDomain = "mycompany.com", ownerName = "mycompany.com", packagePath = "services"))
public class StoryEndpoint {
	...
	public CollectionResponse<Story> listStory(
		...
		return CollectionResponse.<Story> builder().setItems(execute)
